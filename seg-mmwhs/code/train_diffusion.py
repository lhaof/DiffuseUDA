...
if __name__ == '__main__':
    ...
    for epoch_num in iterator:
        for i_batch, sampled_batch in enumerate(zip(labeled_loader, unlabeled_loader)):
            ...
            src_in_trg = FDA_source_to_target(src_img=volume_batch_s,trg_img=volume_batch_t,L=0.25)
            ...
            # Inter-domain
            trg_in_src = FDA_source_to_target(src_img=volume_batch_t,trg_img=volume_batch_s,L=0.25)
